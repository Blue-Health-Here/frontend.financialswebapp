            ...
            {!isVerified ? (
                <>
                    ...
                    <div className="relative md:w-[390px] sm:max-w-md">
                        <Input name="email" placeholder="••••••••" className="h-[42px] border-none shadow-lg rounded-lg font-medium" />
                        <span className="absolute right-3 top-2.5 underline font-bold cursor-pointer text-xs sm:text-sm md:text-[16px]" 
                            onClick={handleVerify}>Verify</span>
                    </div>
                </>
            ) : (
                <>
